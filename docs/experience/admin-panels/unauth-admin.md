---
title: "子域名模糊测试：admin-panels前端验证绕过拿下SQL，升级RCE"
description: "Awesome SRC Experience - 子域名模糊测试：admin-panels前端验证绕过拿下SQL，升级RCE"
---

# 子域名模糊测试：admin-panels前端验证绕过拿下SQL，升级RCE
